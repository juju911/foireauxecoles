-- Sécuriser l'accès aux registrations avec un système de rôles

-- 1. Créer l'enum pour les rôles s'il n'existe pas déjà
DO $$ BEGIN
...
-- 6. Supprimer les anciennes politiques non sécurisées
...
-- 11. Supprimer le trigger existant s'il existe et le recréer
